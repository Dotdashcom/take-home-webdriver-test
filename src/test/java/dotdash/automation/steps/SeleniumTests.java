package dotdash.automation.steps;
...
public class SeleniumTests {
    ...
    public void javaScriptAlerts() {
         ...
         * JS Alert
         */
        pageObject.getJsAlert().click();
        assertEquals("I am a JS Alert", pageObject.getAlertText());
        pageObject.acceptAlert();
        assertEquals("You successfuly clicked an alert", pageObject.getResultText());
        /**
         * JS Confirm
         */
        pageObject.getJsConfirm().click();
        assertEquals("I am a JS Confirm", pageObject.getAlertText());
        pageObject.acceptAlert();
        assertEquals("You clicked: Ok", pageObject.getResultText());
        /**
         * JS Prompt
         */
        pageObject.getJsPrompt().click();
        assertEquals("I am a JS prompt", pageObject.getAlertText());

...
public class TC011_FileUpload extends DriverScript {

	@Test(priority = 1)
	public void login() throws InterruptedException {

		getDriver().get(ConfigProvider.getConfigProp("FileUploadURL"));

		getPageObject().getFileUploadPage().isDisplayedPage();

	}

	@Test(priority = 2)
	public void fileUpload() throws InterruptedException {
		getPageObject().getFileUploadPage().fileUpload();

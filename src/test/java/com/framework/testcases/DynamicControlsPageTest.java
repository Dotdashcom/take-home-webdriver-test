...
public class DynamicControlsPageTest extends TestBase {
    ...
    @Test(priority = 2, description = "User is able to add checkbox")
    ...
    @Test(priority = 2, description = "User is able to enable input field")
    ...
    @Test(priority = 2, description = "User is able to disable input field")

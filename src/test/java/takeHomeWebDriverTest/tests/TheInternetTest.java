...
public class TheInternetTest extends BaseTest{
	...
	public void test8_DynamicControls()
	{
		...
		//Warning :
		//There is a bug with the wait/loading icon which does not disappear even after enabling the input
		//The resulting behavior gives 2 loading icons in the page after enabling and disabling the input
		//Because of this, the explicit wait is applied on the message instead of the text field

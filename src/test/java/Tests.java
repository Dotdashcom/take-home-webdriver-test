...
public class Tests {
    ...
    public void LoginWithValidCredentials() {
        ...
        loginPages.usInput.sendKeys("tomsmith");
        loginPages.pswdInput.sendKeys("SuperSecretPassword!");
    ...
    public void LoginWithInvalidCredentials(){
        driver.get("http://localhost:7080/login");
        loginPages.usInput.sendKeys("tomsmith");
        loginPages.pswdInput.sendKeys("SuperSecretPassw");
        loginPages.loginInput.submit();
    ...
    public void FileUpload() {
        ...
        downloadBtn.sendKeys(System.getProperty("user.dir") + "/src/testdata/downloads/Tests.jpg");

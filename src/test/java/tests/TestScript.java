...
public class TestScript extends BaseTest {
    ...
    public void test01() {
        getDriver().get("http://addrita.a2zlab.online:7080/login");
    ...
    public void test03() {
        getDriver().get("http://addrita.a2zlab.online:7080/checkboxes");
    ...
    public void test04() {
        getDriver().get("http://addrita.a2zlab.online:7080/context_menu");
    ...
    public void test05() {
        getDriver().get("http://addrita.a2zlab.online:7080/drag_and_drop");
    ...
    public void test06() {
        getDriver().get("http://addrita.a2zlab.online:7080/dropdown");
    ...
    public void test07() {
        getDriver().get("http://addrita.a2zlab.online:7080/dynamic_content");
    ...
    public void test08() {
        getDriver().get("http://addrita.a2zlab.online:7080/dynamic_controls");
    ...
    public void test09() {
        getDriver().get("http://addrita.a2zlab.online:7080/dynamic_loading/2");
    ...
    public void test10() {
        getDriver().get("http://addrita.a2zlab.online:7080/download");
        testPage.click(testPage.downloadFile);
    }

    @Test(testName = "File Upload")
    public void test11() {
        getDriver().get("http://addrita.a2zlab.online:7080/upload");
        WebElement addFile = testPage.chooseFile;
        addFile.sendKeys("C://Users//Shuvo//Desktop//test");
    ...
    public void test12() {
        getDriver().get("http://addrita.a2zlab.online:7080/floating_menu");
        Actions action = new Actions(getDriver());
    ...
    public void test13() {
        getDriver().get("http://addrita.a2zlab.online:7080/iframe");
    ...
    public void test14() {
        getDriver().get("http://addrita.a2zlab.online:7080/hovers");
        Actions actions = new Actions(getDriver());
    ...
    public void test15() {
        getDriver().get("http://addrita.a2zlab.online:7080/javascript_alerts");
    ...
    public void test16() {
        getDriver().get("http://addrita.a2zlab.online:7080/javascript_error");
    ...
    public void test17() {
        getDriver().get("http://addrita.a2zlab.online:7080");

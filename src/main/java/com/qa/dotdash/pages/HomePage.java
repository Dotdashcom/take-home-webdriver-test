...
public class HomePage extends Page {
	...
	public DynamicControlPage clickDynamicControls() {
		((Proxywrapper) driver).click(dynamicControls);
		return new DynamicControlPage(driver, true);
	}
	public DynamicLoadPage clickDynamicLoading() {
		((Proxywrapper) driver).click(dynamicLoading);
		return new DynamicLoadPage(driver, true);
	}
	...
	public MouseHoversPage clickHovers() {
		((Proxywrapper) driver).click(hover);
		return new MouseHoversPage(driver, true);
	}

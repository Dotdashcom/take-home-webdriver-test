...
formatter.step({
  "name": "User enters invalid username \"Nottomsmith\" and invalid password \"SuperPassword!\"",
  "keyword": "When "
});
formatter.match({
  "location": "Login.user_enters_invalid_username_and_invalid_password(String,String)"
});
formatter.result({
  "status": "skipped"
});
...
formatter.step({
  "name": "User sees the error message \"message\"",
  "keyword": "Then "
});
formatter.match({
  "location": "Login.user_sees_the_error_message(String)"
});
formatter.result({
  "status": "skipped"
});
